...
def get_model_complexity_info(model, input_res,
    ...
    flops_count, params_count, names = flops_model.compute_average_flops_cost()
    if print_per_layer_stat:
        macs, params = print_model_with_flops(flops_model, flops_count, params_count, ost=ost)
    flops_model.stop_flops_count()
    CUSTOM_MODULES_MAPPING = {}

    if print_per_layer_stat:
        return flops_count, params_count, [macs, params, names]
...
def print_model_with_flops(model, total_flops, total_params, units='GMac',
    ...
    def flops_repr(self):
        ...
        macs.append(accumulated_flops_cost)
        params.append(accumulated_params_num)
...
def compute_average_flops_cost(self):
    ...
    return flops_sum / self.__batch_counter__, params_sum, names
